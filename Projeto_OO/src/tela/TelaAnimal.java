...
public class TelaAnimal implements ActionListener, ListSelectionListener {
	...
	public void mostrarDados(ControleDados d,int op) {
		...
		case 1://Mostrar Dados de Aves cadastradas
			...
			botaoVoltar.setBounds(30,177,100,30);
			cadastroAve.setBounds(140,177,100,30);
			refreshAve.setBounds(250,177,100,30);
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if(e.getValueIsAdjusting() && src == listaAvesCadastrados) {
			new TelaDetalheAnimal().inserirEditar(5, dados, this, 
					listaAvesCadastrados.getSelectedIndex());
		}
		// Atualiza a lista de nomes dos cachorros mostrados no JList
		if(e.getValueIsAdjusting() && src == listaCachorrosCadastrados) {
			new TelaDetalheAnimal().inserirEditar(6, dados, this, 
		...
		if(e.getValueIsAdjusting() && src == listaGatosCadastrados) {
			new TelaDetalheAnimal().inserirEditar(7, dados, this, 
		...
		if(e.getValueIsAdjusting() && src == listaVacinasCadastrados) {
			new TelaDetalheAnimal().inserirEditar(8, dados, this, 
					listaVacinasCadastrados.getSelectedIndex());
		}
